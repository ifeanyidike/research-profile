...
Reproduced and extended a 2024 _Economics_ paper applying LASSO-regularized feature selection and MLP neural networks to predict daily trend direction (up/down) in equity ETFs. Targets: ECH (Chile), EWZ (Brazil) as emerging market proxies, and IVV (S&P 500) as a developed-market benchmark.
