...
### 3d. Switching to the supported model

We tried requesting the model that supports the feature. The platform **silently downgraded** it. No path to that model through the platform.
